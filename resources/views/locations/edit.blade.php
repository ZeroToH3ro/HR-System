            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" accept="{{ url('admin/locations/edit') }}" enctype="multipart/form-data" method="post">
                            {{ csrf_field() }}
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="city" value="{{ $getRecord->city }}" class="form-control" required placeholder="Enter City">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="state_province" value="{{ $getRecord->state_province }}" class="form-control" required placeholder="Enter State Province">
                                    </div>
                                </div>
