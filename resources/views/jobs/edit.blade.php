            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="{{ url('admin/jobs/edit/'.$getRecord->id) }}" enctype="multipart/form-data" method="post">
                            {{ csrf_field() }}
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-lable">Job Title <span style="color: red">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="job_title" value="{{ $getRecord->job_title }}" class="form-control" required placeholder="Enter Job Name">
                                    </div>
                                </div>
