            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" accept="{{ url('admin/departments/edit/'.$getRecord->id) }}" enctype="multipart/form-data" method="post">
                            {{ csrf_field() }}
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="locations_id">
                                            ...
                                            @foreach ($getLocations as $item)
                                                <option {{ ($getRecord->locations_id == $item->id ) ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->street_address }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
